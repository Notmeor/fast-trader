...
_ORDERSTATUS = _descriptor.EnumDescriptor(
  name='OrderStatus',
  full_name='dwjk.dtp_.OrderStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_FILLSTATUS = _descriptor.EnumDescriptor(
  name='FillStatus',
  full_name='dwjk.dtp_.FillStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_QUERYORDERCRITERIA = _descriptor.EnumDescriptor(
  ...
  full_name='dwjk.dtp_.QueryOrderCriteria',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
