...
class MyStrategy(Strategy):
    ...
    def on_start(self):
        ...
        self.market_indexes = defaultdict(list)
    ...
    def on_market_index(self, market_index):
        data = market_index['content']
        self.market_indexes[data.szCode].append(data)
...
if __name__ == '__main__':
    ...
    # 订阅行情
    datasource_0 = QuoteFeed('index_feed')
    datasource_0.subscribe(['002230'])
    datasource_0.subscribe_all()
